...
class Player{
    ...
    draw(){
        ...
        // c.translate(this.position.x, this.position.y + this.height)
...
function animate(){
    ...
    // }else if(keys.s.pressed && player.position.x + player.height <= canvas.height){
    //     player.velocity.y = player.speed
    }else{
        player.velocity.x = 0
        player.rotation = 0
...
addEventListener('keydown', ({key})=>{
    ...
    if(key == 'd' || key == 'ArrowRight')keys.d.pressed = true
...
addEventListener('keyup', ({key})=>{
    if(key == 'a' || key == 'ArrowLeft')keys.a.pressed = false
    if(key == 'd' || key == 'ArrowRight')keys.d.pressed = false
    // if(key == 'w')keys.w.pressed = false
    // if(key == 's')keys.s.pressed = false
    if(key == ' ')keys.space.pressed = false
})